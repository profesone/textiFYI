<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('client.company_name') ? 'invalid' : '' }}">
        <label class="form-label" for="company_name">{{ trans('cruds.client.fields.company_name') }}</label>
        <input class="form-control" type="text" name="company_name" id="company_name" wire:model.defer="client.company_name">
        <div class="validation-message">
